...
function processV1Request (request, response) {
  ...
  const actionHandlers = {
    ...
    // Our custom GetNuggetByTypeAction was matched, get a nugget and respond!
    'GetNuggetByTypeAction': () => {
      let response = "Oops, there was an error retrieving your nugget, please try again."
      let nugget = getNuggetByType(parameters.NuggetType)
      if(nugget) {
